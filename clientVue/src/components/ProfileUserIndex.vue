            ...
            <table class="table"> 
                ...
                <template v-for="profile in profiles" :key="profile._id">
                    <tr class="table-user-row">
                        <transition-group name="profile-user-index">
...
.profile-user-index-enter-active,
.profile-user-index-leave-active {
  transition: all 0.3s ease;
}
.profile-user-index-enter-from,
.profile-user-index-leave-to {
  opacity: 0;
  transform: translateX(30px);
}

/* Animation move */
.profile-user-index-move {
